...
function enviarRelatorio() {
    ...
    const photos = document.getElementById('photos').getElementsByTagName('img');
    if (photos.length > 0) {
        const dataURL = photos[0].src; // Considera apenas a primeira foto para simplicidade
...
document.getElementById('camera-init-button').addEventListener('click', function () {
    mostrarCamera();
});